...
<html lang="zxx">
    <head>
        ...
        <link rel="stylesheet" href="css/userpenal.css" />
    ...
    <body class="crm_body_bg">
        <nav class="sidebar">
            ...
            <ul id="sidebar_menu">
                ...
                <li>
                    <a href="./user-profile-page.html" aria-expanded="false">
                        <div class="nav_icon_small">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                ...
                <li>
                    <a href="admin-course.html" aria-expanded="false">
                        <div class="nav_icon_small">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                ...
                <li class="">
                    <a
                        class=""
                        href="admin-dashboard-setting.html"
                        aria-expanded="false"
                    >
                        <div class="nav_icon_small">
                            <svg
        ...
        <section class="main_content dashboard_part large_header_bg">
            <div class="container-fluid g-0">
                        ...
                        >
                            <div class="d-flex align-items-center">
                                ...
                                >
                                    ...
                                    <div
                                        class="slider round open_miniSide"
                                    ></div>
                                </label>
                            ...
                            >
                                <div
                                    class="header_notification_warp d-flex align-items-center"
                                >
                                    <li>
                                        <a
                                        ...
                                        <div class="Menu_NOtification_Wrap">
                                            ...
                                            <div class="nofity_footer">
                                                <div
                                                    class="submit_button text-center pt_20"
                                                >
                                                    <a
                                                        href="./aadmin-dashboard-notification-page.html"
                                                        class="btn_1"
                                                        >See More</a
                                                    >
                                                </div>
                ...
                <div
                    class="row teacher-detail-page-row1 row teacher-detail-page-row2"
                >
                                ...
                                <div class="dropdown-category">
                                    ...
                                    <div class="d-flex mt-3">
                                        <div>
                                            ...
                                            <button
                                                class="btn-category btn-category-2 mt-2"
                                            >
                                                Intermediate
                                            </button>
                                        </div>
                                        <div class="ms-3">
                                            <button
                                                class="btn-category btn-category-2"
                                            >
                                                Beginner
                                            </button>
                                            <button class="btn-category mt-2">
                                                Master
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-4">
                                    <div class="sidebar-card-2-dashboard-user">
                                        <div
                                            class="sidebar-card2-inner-card-userpenal"
                                        >
                                            <div
                                                class="justify-content-center d-flex align-items-center"
                                            >
                                                <img
                                                    src="./images/my-course-card1.png"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
                                            ...
                                            >
                                                <p>
                                                    <img
                                                        src="./images/course-card-img1.png"
                                                        alt=""
                                                        class="me-2"
                                                ...
                                                <h6>
                                                    ...
                                                    >
                                                        <path
                                                            d="M9.60156 3.06934L11.5415 7.57405L16.4252 8.027L12.7404 11.264L13.8188 16.0487L9.60156 13.5445L5.38432 16.0487L6.46268 11.264L2.77792 8.027L7.66162 7.57405L9.60156 3.06934Z"
                                                            fill="#FFBB54"
                                                        /></svg
                                                    >4.5
                                                </h6>
                                            ...
                                            <div class="mt-3">
                                                <span
                                                    ...
                                                    >
                                                        <path
                                                            d="M7.99984 8.00016C9.84079 8.00016 11.3332 6.50778 11.3332 4.66683C11.3332 2.82588 9.84079 1.3335 7.99984 1.3335C6.15889 1.3335 4.6665 2.82588 4.6665 4.66683C4.6665 6.50778 6.15889 8.00016 7.99984 8.00016Z"
                                                            stroke="#9C9CA4"
                                                            stroke-width="1.5"
                                                            stroke-linecap="round"
                                                            stroke-linejoin="round"
                                ...
                                <div class="col-md-4 mt-4 mt-md-0">
                                    <div class="sidebar-card-2-dashboard-user">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="./images/my-course-card3.png"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
                                            <h3>
                                                Creating Beautifull Landing Page
                                                in 1 Hour
                                            </h3>
                                            <div
                                                class="justify-content-between d-flex mt-2"
                                ...
                                <div class="col-md-4 mt-4 mt-md-0">
                                    <div class="sidebar-card-2-dashboard-user">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="./images/my-course-card4.png"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="sidebar-card-2-dashboard-user">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="./images/my-course-card5.png"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
                                            <h3>
                                                UI UX Design : Design System To
                                                Create Design Faster
                                            </h3>
                                            <div
                                                class="justify-content-between d-flex mt-2"
                                            >
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="sidebar-card-2-dashboard-user">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="./images/my-course-card6.png"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
                                            <h3>
                                                UI UX Design : Wireframe To
                                                Define Idea
                                            </h3>
                                            <div
                                                class="justify-content-between d-flex mt-2"
        ...
        ></script>
        <script>
            const wheelables = [].slice.call(
                document.querySelectorAll(".wheelable")
            );
            ...
            const digits = [].slice.call(
                document.querySelectorAll(".digits-container input")
            );
