        ...
        <div class="container-fluid p-0">
          <div class="row">
            ...
            <div class="row enroll-course-page-row1">
                ...
                <div class="row mt-3 assingment-userpeanl-course-explore-contetn">
                    <h3>1.Make a simple animation from figma prototype</h3>
                    <p>Let’s return to design thinking. Over time designers have built up their own body of approaches to solving classes of problems.</p>
                  <div class="col-md-6 col-12 mt-3">
                    <div class="d-flex">
                      <div class="upload-input-feild-detail">
                        <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Calender">
                    </div>
                    <div>
                      <a href=""> <button class="detail-btn-assingment ms-4"> Detail</button></a>
                    </div>
                    </div>
                  </div>
                  <div class="col-md-6 col-12 d-flex collected-class-student mt-3">           
                      <h5>40 Students Collected</h5>
                      <h5 class="ms-2" style="color: var(--secondary-red, #DB5962);">1 Days Left</h5>
                  </div>
                </div>
                <div class="row mt-3 assingment-userpeanl-course-explore-contetn">
                  <h3>2. Make a micro interaction with principle</h3>
                  <p>Let’s return to design thinking. Over time designers have built up their own body of approaches to solving classes of problems.</p>
                <div class="col-md-6 col-12 mt-3">
                  <div class="d-flex">
                    <div class="upload-input-feild-detail">
                ...
                <div class="col-md-6 col-12 collected-class-student mt-3">           
                    <h5>40 Students Collected</h5>
                    <h5 class="ms-2" style="color: var(--secondary-red, #DB5962);">1 Days Left</h5>
                </div>
              </div>
              <!-- row2 -->
              <div class="row mt-3 assingment-userpeanl-course-explore-contetn">
                <h3>3. Make a showcase animation for dribbble</h3>
                <p>Let’s return to design thinking. Over time designers have built up their own body of approaches to solving classes of problems.</p>
              <div class="col-md-6 col-12 mt-3">
                <div class="d-flex">
                  <div class="upload-input-feild-detail">
              ...
              <div class="col-md-6 col-12 mt-3 collected-class-student">           
                  <h5>40 Students Collected</h5>
                  <h5 class="ms-2" style="color: var(--secondary-red, #DB5962);">1 Days Left</h5>
              </div>
            </div>
