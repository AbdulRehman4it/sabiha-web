            ...
            <div class="col-xl-8">
              <div class="row my-teacher-row">
                <div class="col-md-12">
                  ...
                  <div class="my-teacher-row2">
                  <!-- cerasoul -->    
                     <a href="{{('teacher_detail_page_userpanel')}}">
                  ...
                  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <!-- <a href="{{('teacher_detail_page_userpanel')}}"> -->
                      <div class="carousel-item active">
                        <div class="d-flex justify-content-between d-block w-100">
                          <div class="d-flex">
                            <div>
                              <img src="{{url('userpanel./images/my-teacher-img1.png')}}" class="img-fluid" alt="">
                            </div>
                            <div class="ms-3">
                              <h3>Emerson Levin</h3>
                              <p>UI UX . Design</p>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="my-course-card">
                <div class="my-course-card-inner-body">
                  <div class="d-flex justify-content-center align-items-center ">
                    <img src="{{url('userpanel./images/my-course-card1.png')}}" alt="" class="img-fluid" width="100%">
                  </div>
                  <div class="my-course-card-inner-content">
                    <h2>Introduction Basic 
            ...
            <div class="col-md-6 mt-4 mt-md-0">
              <div class="my-course-card">
                <div class="my-course-card-inner-body">
                  <div class="d-flex justify-content-center align-items-center ">
                    <img src="./images/my-course-card1.png" alt="" class="img-fluid" width="100%">
                  </div>
                  <div class="my-course-card-inner-content">
                    <h2>Creating Beautifull Landing Page in 1 Hour</h2>
                      <div class="justify-content-between d-flex mt-2">
                      <p ><img src="./images/course-card-img1.png" alt="" class="me-2">Emerson Siphron</p>
                      <h6><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M9.60156 3.06934L11.5415 7.57405L16.4252 8.027L12.7404 11.264L13.8188 16.0487L9.60156 13.5445L5.38432 16.0487L6.46268 11.264L2.77792 8.027L7.66162 7.57405L9.60156 3.06934Z" fill="#FFBB54"/>
                      </svg>4.5</h6> </div>
                      <div class="progress mt-2">
                        <div class="progress-bar progress-bar-2" role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="20" aria-valuemax="100"></div>
                      </div>
                      <div class="justify-content-between d-flex mt-2">
                        <h6>1/5 Module</h6>
                        <h6>20%</h6></div>
            ...
            <div class="row mt-5">
              <div class="col-md-12">
                <div class="sidebar-card-2-dashboard-user">
                  ...
                  <div class="mt-3">
                    <a href=""><button class="go-to-detail-btn">Go To Detail</button></a>
