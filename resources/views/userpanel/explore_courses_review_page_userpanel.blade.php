            ...
            <div class="row enroll-course-page-row1">
                ...
                <span class="ms-2 float-end">Master <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12" fill="none">
                  ...
                  <div class="row overview-link">
                    ...
                    <div class="col-md-3 col-4">
                      <a href="{{url('explore_courses_review_page_userpanel',$feature_courses->id)}}"><h3 class="active">Review</h3> </a>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="review-page-headings-userpenal">
                      <h5>Jason Smith</h5>
                      <div class="row">
        ...
        <div class="row mt-3 mt-md-5">
            ...
            <div class="sidebar-card-2-dashboard-user">
              <div class="sidebar-card2-inner-card-userpenal">
                <div class="justify-content-center d-flex align-items-center">
                  <img src="./images/my-course-card1.png" alt="" width="100%" >
                </div>
                <h3>Introduction Basic 
                  Programming HTML & CSS</h3>
                <div class="justify-content-between d-flex mt-2">
                  <p ><img src="./images/course-card-img1.png" alt="" class="me-2">Alfredo Rhiel Madsen</p>
                  <h6><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M9.60156 3.06934L11.5415 7.57405L16.4252 8.027L12.7404 11.264L13.8188 16.0487L9.60156 13.5445L5.38432 16.0487L6.46268 11.264L2.77792 8.027L7.66162 7.57405L9.60156 3.06934Z" fill="#FFBB54"/>
                  </svg>4.5</h6> </div>
                <div class="mt-3">
          ...
          <div class="col-md-4 mt-4 mt-md-0">
            <div class="sidebar-card-2-dashboard-user">
              <div class="sidebar-card2-inner-card-userpenal">
                <div class="justify-content-center d-flex align-items-center">
                  <img src="./images/my-course-card3.png" alt="" width="100%" >
                </div>
                <h3>Creating Beautifull Landing Page in 1 Hour</h3>
                <div class="justify-content-between d-flex mt-2">
                  <p ><img src="./images/tchr1.png" alt="" class="me-2">Lincoln George</p>
                  <h6><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M9.60156 3.06934L11.5415 7.57405L16.4252 8.027L12.7404 11.264L13.8188 16.0487L9.60156 13.5445L5.38432 16.0487L6.46268 11.264L2.77792 8.027L7.66162 7.57405L9.60156 3.06934Z" fill="#FFBB54"/>
                  </svg>4.5</h6> </div>
                <div class="mt-3">
          ...
          <div class="col-md-4 mt-4 mt-md-0">
            <div class="sidebar-card-2-dashboard-user">
              <div class="sidebar-card2-inner-card-userpenal">
                <div class="justify-content-center d-flex align-items-center">
                  <img src="./images/my-course-card4.png" alt="" width="100%" >
                </div>
