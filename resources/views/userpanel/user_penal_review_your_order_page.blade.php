        ...
        <div class="container-fluid p-0">
          <div class="row">
            <div class="col-xl-8">
              ...
              <div class="row payment-row pt-3 mb-3">
             ...
             <div class="row">
              <div class="col-md-12">
                <div class="userpenal-revie-your-order-img">
                  <img src="{{url('userpanel./images/review-your-order-page-bg.png')}}" alt="">
                </div>
                <div class="userpanel-review-your-order-content">
                  <h2>
                    Learn Psychology or improve your skills online today
                  </h2>
            ...
            <div class="col-xl-4 my-cart-crd ">
                <div class="cart-card">
                  <div class="cart-cardbody">
                    <h3>Subtotal <span class="float-end">$160.00</span></h3>
                    <h4>Delivery Charge <span class="float-end">$5.00</span></h4>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <div class="model-img">
              <img src="{{url('userpanel./images/logo-popup.png')}}" alt="">
            </div>
            <h2>Payment is confirmed you are enroll successfully</h2>
            <p> Reference site about Lorem Ipsum, giving information on its origins, as well as a random Lipsum generator.</p>
          </div>
          <button class="view-order-button"><a href="{{('enroll_course_page_userpanel')}}">View Course</a></button>
          <button class="back-to-home-button"><a href=""  class="back-to-home-button-a">Back to Home</a></button>
        </div>
      </div>
    </div>
  </div>
