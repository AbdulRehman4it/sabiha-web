          ...
          <div class="row">
            ...
            <div class="white_card mb_30 general">
                  <div class="row user-profile">
                    <h2>Edit Profile</h2>
                  <div class="userpenal-profile-img-div d-flex">
                    <div class="justify-content-center align-items-center">
                      <img src="{{url('userpanel./images/profile-img-upload.png')}}" alt="" width="100%">
                    ...
                    <div class="upload-content">
                      <h3>Upload Photo</h3>
                      <p>300x300 and max 2 MB</p>
                    </div>
                  </div>
                  <form>
                    <div class="col-md-6 upload-input-feild">
                      <label for="exampleInputEmail1" class="form-label">Full Name</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Pristia Candra">
                    </div>
                    <div class="col-md-6 upload-input-feild">
                    ...
                    <div class="col-md-6 upload-input-feild">
                      ...
                      <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="01 Apr 1997">
                    </div>
                    <div class="col-md-6 upload-input-feild">
                      <label for="exampleInputEmail1" class="form-label">Phone Number</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" +62 809 9239 1212">
                    </div>
                    <div class="col-md-6 upload-input-feild">
                      <label for="exampleInputEmail1" class="form-label">Card Detail</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" 62 809 9239 1212">
                    </div>
                    <div class="col-md-6 upload-input-feild">
                      <label for="exampleInputEmail1" class="form-label">Bio</label>
                      <input type="text" class="form-control bio-form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="|Brief description for your profile.">
                    </div>
                    <div class="upload-input-feild">
                      <a href="">
                      <button type="submit" class="btn save-change">Save Change</button>
                    </a>
                    </div>
                  </form>
                  </div>       
                    ...
                    <h2>Other Information</h2>
                      <form class="row g-3">
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="email" class="form-control" id="inputEmail4" placeholder="New York">
                        </div>
                        <div class="col-md-4">
                          <label for="inputState" class="form-label">Zipcode</label>
                          <input type="email" class="form-control" id="inputEmail4" placeholder="77812">
