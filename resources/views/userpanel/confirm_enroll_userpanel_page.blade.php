                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="userpenal-revie-your-order-img">
                                        <img
                                            src="{{url('userpanel./images/review-your-order-page-bg.png')}}"
                                            alt=""
                                        />
                                    </div>
                                    <div
                                        class="userpanel-review-your-order-content"
                                    >
                                        <h2>
                                            Learn Psychology or improve your
                                            skills online today
                                        </h2>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 my-cart-crd mt-5">
                            <div class="cart-card">
                                <div class="cart-cardbody">
                                    <h3>
                                        Subtotal
                                        <span class="float-end">$160.00</span>
                                    </h3>
                                    ...
                                    <h4>
                                        TAX <span class="float-end">$5.00</span>
                                    </h4>

                                    <h2>
                                        Grand Total
                                        <span class="float-end">$165.00</span>
                                    </h2>
                                    <div class="cart-card-btn">
                                        <button>
                                            <a href="{{('user_penal_payment_method_page')}}"
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2>
                            Payment is confirmed you are enroll successfully
                        </h2>
                        <p>
                    ...
                    <button class="view-order-button">
                        <a href="./checkout-page.html">View Course</a>
                    </button>
