                                ...
                                <div class="col-md-4">
                                    <div class="sidebar-card-2-dashboard-user">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="{{url('userpanel./images/my-course-card1.png')}}"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
                                            ...
                                            >
                                                <p>
                                                    <img
                                                        src="{{url('userpanel./images/course-card-img1.png')}}"
                                                        alt=""
                                                        class="me-2"
                                ...
                                <div class="col-md-4 mt-4 mt-md-0">
                                    <div class="sidebar-card-2-dashboard-user">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="{{url('userpanel./images/my-course-card3.png')}}"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
                                            ...
                                            >
                                                <p>
                                                    <img
                                                        src="{{url('userpanel./images/tchr1.png')}}"
                                                        alt=""
                                                        class="me-2"
                                                    />Lincoln George
                                                </p>
                                ...
                                <div class="col-md-4 mt-4 mt-md-0">
                                    <div class="sidebar-card-2-dashboard-user">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="{{url('userpanel./images/my-course-card4.png')}}"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="sidebar-card-2-dashboard-user">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="{{url('userpanel./images/my-course-card5.png')}}"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="sidebar-card-2-dashboard-user">
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src="{{url('userpanel./images/my-course-card6.png')}}"
                                                    alt=""
                                                    width="100%"
                                                />
                                            </div>
