      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="row overview-link">
            ...
            <div class="col-md-2 col-6">
              <a href="{{url('course_detail_review_page',$feature_courses->id)}}"><h3>Reviews</h3> </a>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="course-overview">
                ...
                <p>
                {{$feature_courses->course_overview}}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row mb-5">
            <div class="col-md-12">
              <div class="course-overview course-overview-requirements-sec">
                <h2>Requirements</h2>
                <p>
        ...
        <div class="col-md-4">
          <div class="psychology-card">
            <div class="card-content">
              ...
              @if(session()->has('success'))
                ...
                <a href="{{url('add_cart',$feature_courses->id)}}"> 
          ...
          <div class="buy-button">
                ...
                <a href="{{url('checkoutpage')}}"><button class="btn">Buy Now</button></a>
              </div>
