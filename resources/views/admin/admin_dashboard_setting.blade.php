            ...
            <div class="white_card mb_30">
                  <div class="row setting-page">
                    <div class="col-md-2 col-4">
                      <a href="{{url('admin_dashboard_setting')}}"><h4 class="active">General</h4> </a>
                    </div>
                    <div class="col-md-2 col-4">
                      <a href="{{url('admin_dashboard_setting_password_page')}}"><h4>Password</h4> </a>
                    </div>
                    <div class="col-md-2 col-4">
                  ...
                  <div class="row setting-row-general">
                    <div class="col-md-6 setting-dashboard-form">
                      <form class="row g-3">
                        <div class="col-md-12">
                          <label for="inputState" class="form-label">Language
                           </label>
                          <select id="inputState" class="form-select setting-slct">
                        ...
                        <div class="col-md-12">
                          ...
                          <label for="inputState" class="form-label ">
                            Timezone</label>
                          <div class="col-md-6 setting-radio-check active">
                          ...
                          <div class="col-md-6 setting-radio-check">
                            <label class="form-check-label " for="flexRadioDefault1">
                            12 Hours
                            </label>
                     ...
                     <a href=""><button class="btn mt-3">Save Change</button></a>
