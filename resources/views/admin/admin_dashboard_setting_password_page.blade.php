            ...
            <div class="white_card mb_30">             
              ...
              <div id="form2">
                <div class="row setting-page formdata">
                  ...
                  <div class="col-md-2 col-4">
                    <a href="{{url('admin_dashboard_setting_password_page')}}" id="form2show"><h4 class="active" >Password</h4> </a>
                  </div>
                  <div class="col-md-2 col-4">
                    <a href="{{url('admin_dashboard_setting_notification_page')}}"><h4>Notification</h4> </a>
                  </div>
                ...
                <div class="row setting-row-general">
                  <div class="col-md-6">
                    <form class="row g-3">
                      <div class="col-md-12">
                      <label for="inputState" class="form-label">Old Password</label>
                        <input type="email" class="form-control" id="inputEmail4" placeholder="Input your old password">
                      </div>
                        <div class="col-md-12">
                      <label for="inputState" class="form-label">New Password</label>
                          <input type="email" class="form-control" id="inputEmail4" placeholder="Input your new password">
                        </div>
                        <div class="col-md-12 mb-3">
                           <label for="inputState" class="form-label">Retype New Password</label>
                          <input type="email" class="form-control" id="inputEmail4" placeholder="Input again your new password">
                        </div>
