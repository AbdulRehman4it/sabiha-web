@include('admin.layout.header')
            ...
            <div class="white_card mb_30 general">
                  <div class="row general-row">
                    ...
                    <div class="col-md-6">
                      <form class="row g-3">
                        <div class="col-md-12 ">
                          <label for="inputEmail4" class="form-label">Tittle</label>
                          <input type="text" class="form-control" id="inputEmail4" placeholder="Type Here">
                        </div>
                      
                        <div class="col-md-12">
                          <label for="inputPassword4" class="form-label">Description</label>
                          <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" style="height: 163px;" placeholder="Type Here"></textarea>
                        </div>
                      </form>
                    </div>
                    <div class="col-md-6">
  ...
  <div class="upload-list"></div>
                        ...
                        <div class="col-md-6">
                          <label for="inputEmail4" class="form-label">Skill Level</label>
                          <select id="inputState" class="form-select">
                            <option selected>Please Select</option>
                            <option>...</option>
                          </select>
               ...
               <!-- form1 -->
                  ...
                  <div class="col-md-12">
                    <h2 class="mb-5">Course Content</h2>
                    <form class="row g-3 course-content">
                      ...
                      <div class="col-md-5 mt-0">
                        <div class="row align-items-center">
                          <div class="col-md-3">
                          <label for="label" class="col-sm-2 col-form-label">Tittle</label>
                          </div>
                          <div class="col-md-9">
                            <input type="text" class="form-control" id="inputPassword" placeholder="Type Here">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-5">
                        ...
                        <div class="progress">
                          <div class="progress-bar bg-danger" role="progressbar" style="width: 85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="85"></div>
                        </div>
                      </div>
                    </form>
                  </div>
                  ...
                  <div class="row other-information">
                    <div class="col-md-12">
                      <form class="row g-3 course-content">
                        ...
                        <div class="col-md-5 mt-0 upload-button">
                         
                            <button class="mt-4 mt-md-0 btn"  type="button"
                            data-bs-toggle="modal"
                            data-bs-target="#exampleModal">
                              <span class="me-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <g clip-path="url(#clip0_911_4132)">
                                  <path d="M10.667 2.66699C11.035 2.66699 11.3337 2.96566 11.3337 3.33366V6.13366L14.809 3.70033C14.9597 3.59499 15.1677 3.63166 15.2737 3.78299C15.3123 3.83899 15.3337 3.90566 15.3337 3.97366V12.027C15.3337 12.211 15.1843 12.3603 15.0003 12.3603C14.9317 12.3603 14.865 12.339 14.809 12.3003L11.3337 9.86699V12.667C11.3337 13.035 11.035 13.3337 10.667 13.3337H1.33366C0.965659 13.3337 0.666992 13.035 0.666992 12.667V3.33366C0.666992 2.96566 0.965659 2.66699 1.33366 2.66699H10.667ZM10.0003 4.00033H2.00033V12.0003H10.0003V4.00033ZM6.00033 5.33366L8.66699 8.00033H6.66699V10.667H5.33366V8.00033H3.33366L6.00033 5.33366ZM14.0003 5.89433L11.3337 7.76099V8.23966L14.0003 10.1063V5.89366V5.89433Z" fill="#DF5C62"/>
                                </g>
                                <defs>
                                  <clipPath id="clip0_911_4132">
                  ...
                  <div class="row mt-4">
                    <div class="col-md-12 add-chapter-button">
                        <a href="http://">
                         <button>
                           <span class="me-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g clip-path="url(#clip0_911_4139)">
                              <path d="M7.33301 7.33301V3.33301H8.66634V7.33301H12.6663V8.66634H8.66634V12.6663H7.33301V8.66634H3.33301V7.33301H7.33301Z" fill="white"/>
                            </g>
                            <defs>
                              <clipPath id="clip0_911_4139">
                                <rect width="16" height="16" fill="white"/>
                              </clipPath>
                            </defs>
                          </svg></span>Add Chapter
                          </button>
                        </a>
                     
                    </div>
                  </div>
                  <div class="publish-course-button mt-4">
                     <a href="#">
                         <button>
                           <span class="">Publish Course</span>
                          </button>
                        </a>
                        </div>
            </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <div class="br-upload pop-up-br-upload">
              <label class="upload-label" for="single-file">
                <span>
                     <h3>Drop more file(s) here or <span style="color: #DF5C62;">browse</span></h3>
                      <p>Max. File Size: 200MB</p>
                </span>
              </label>
               <input class="upload-input" id="single-file" type="file" accept=".pdf, .docx, image/jpeg .mp4"/>
                <div class="upload-list"></div>
                </div>
          </div>
        </div>
        <div class="row p-2">
          <div class="col-md-12 uploading-row-popup-btn">
            <div class="uploading-content justify-content-between d-flex">
              <p>Uploading:<span>Part2.mp4</span></p>
              <p>25%<span>12 minutes remaining</span></p>
            </div>
            <div class="progress mt-3">
              <div class="progress-bar" role="progressbar" style="width: 85%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="85">
             </div>
            </div>
          </div>
        </div>
