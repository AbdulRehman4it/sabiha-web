                    ...
                    <div class="Menu_NOtification_Wrap">
                      ...
                      <div class="nofity_footer">
                        <div class="submit_button text-center pt_20">
                          <a href="{{url('aadmin_dashboard_notification_page')}}" class="btn_1">See More</a>
                        </div>
                      </div>
                    </div>
                  </li>
...
@include('admin.layout.card_sec')
                ...
                <div class="white_card_header">
                  <div class="box_header m-0">
                    <div class="main-title">
                      <h3 class="m-0">Total Revenue</h3>
                    </div>
                    <div
                      class="float-lg-right float-none common_tab_btn2 justify-content-end"
                    >
                    <select>
                        <option>2001</option>
                        <option>2002</option>
            ...
            <div class="col-xl-4">
              <div class="white_card card_height_100 mb_30">
                <div class="white_card_header">
                  <div class="box_header m-0">
                    <div class="main-title">
                      <h3 class="m-0">Sales Overview</h3>
                      <!-- <span>15654 Visaitors</span> -->
                    </div>
                    <div
                      class="float-lg-right float-none common_tab_btn justify-content-end"
                    >
                    <select>
                        <option>2001</option>
                        <option>2002</option>
          ...
          <div class="row mt-4">
            <div class="col-md-3">
                <div class="d-flex align-items-center justify-content-between gap-3 chart-card">
                    <div>
                        <p>New Student</p>
                        <h2>200</h2>
                        <h3>+10%</h3>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="88" height="64" viewBox="0 0 88 64" fill="none">
                        <rect y="38" width="4" height="16" fill="#E7777D"/>
                        <rect x="14" y="31" width="4" height="23" fill="#E7777D"/>
                        <rect x="21" y="23" width="4" height="31" fill="#E7777D"/>
                        <rect x="28" y="30" width="4" height="24" fill="#E7777D"/>
                        <rect x="42" y="29" width="4" height="25" fill="#E7777D"/>
                        <rect x="49" y="29" width="4" height="25" fill="#E7777D"/>
                        <rect x="56" y="10" width="4" height="44" fill="#E7777D"/>
                        <rect x="70" y="32" width="4" height="22" fill="#E7777D"/>
                        <rect x="77" y="26" width="4" height="28" fill="#E7777D"/>
                        <rect x="84" y="31" width="4" height="23" fill="#E7777D"/>
                        <rect x="63" y="16" width="4" height="38" fill="#E7777D"/>
                        <rect x="35" y="40" width="4" height="14" fill="#E7777D"/>
                        <rect x="7" y="38" width="4" height="16" fill="#E7777D"/>
                      </svg>
                    
                </div>
            </div>
            <div class="col-md-3 mt-3 mt-md-0">
                <div class="d-flex align-items-center justify-content-between gap-5 chart-card">
                    <div>
                        <p>Earnings</p>
                        <h2>$2,80,00</h2>
                        <h3>+20%</h3>
