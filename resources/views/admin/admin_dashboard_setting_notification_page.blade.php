        ...
        <div class="container-fluid p-0">
          <div class="row">
            ...
            <div class="white_card mb_30">             
              <!-- ===============FORM 2=========== -->
              <div id="form2">
                <div class="row setting-page formdata">
                  <div class="col-md-2 col-4">
                    <a href="{{url('admin_dashboard_setting')}}"><h4>General</h4> </a>
                  </div>
                  <div class="col-md-2 col-4">
                    <a href="{{url('admin_dashboard_setting_password_page')}}" id="form2show"><h4 >Password</h4> </a>
                  </div>
                  <div class="col-md-2 col-4">
                    <a href="{{url('admin_dashboard_setting_notification_page')}}"><h4 class="active" >Notification</h4> </a>
                  </div>
                  <div class="col-md-6 d-none d-md-block"></div>
                </div>   
                <div class="row setting-row-general">
                  <div class="col-md-6">
                    <form class="row g-3 ms-4 video-row-seting">
                      <div class="col-md-12">
                      <div class="form-check form-switch  noti-switch">
                        <input class="form-check-input form-check-input2" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                        <label class="form-check-label " for="flexSwitchCheckChecked">Upload Video
                        </label>
                      </div>
                        <div class="form-check form-switch  noti-switch">
                          <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                          <label class="form-check-label " for="flexSwitchCheckChecked">Newest Update
                          </label>
                        </div>
                        <div class="form-check form-switch  noti-switch">
                          <input class="form-check-input " type="checkbox" role="switch" id="flexSwitchCheckChecked" >
                          <label class="form-check-label " for="flexSwitchCheckChecked">Comment
                          </label>
                        </div>
                        ...
                        <div class="form-check form-switch  noti-switch">
                          <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" >
                          <label class="form-check-label " for="flexSwitchCheckChecked"> Course Of The Month
                          </label>
                        </div>
                        </div>     
                            <a href="" class="mt-5"><button class="btn">Save Change</button></a> 
                    </form>
                  </div>
            ...
            <!-- <div id="form3">
              <div class="row setting-page formdata">
                ...
                <div class="col-md-2 col-4">
                  <a href=""><h4 >Password</h4> </a>
                </div>
                <div class="col-md-2 col-4">
                  <a href=""><h4 class="active" id="form3show">Notification</h4> </a>
                </div>
                <div class="col-md-6 d-none d-md-block"></div>
              </div>   
              <div class="row setting-row-general">
                <div class="col-md-6">
                  <form class="row g-3">
                    <div class="col-md-12">
                      <label for="inputState" class="form-label">Language
                    ...
                    <div class="col-md-12">
                      ...
                      <label for="inputState" class="form-label">Timezone</label>
                      <div class="col-md-6">
                        <input type="email" class="form-control" id="inputEmail4" placeholder="24 Hours">
                      </div>
                      <div class="col-md-6">

                        <input type="email" class="form-control" id="inputEmail4" placeholder="12 Hours">

                      </div>
                      <label for="inputState" class="form-label">Date Format</label>
                      <div class="col-md-6">
                        <input type="email" class="form-control" id="inputEmail4" placeholder="mm/dd/yyyy">
                      </div>
                      <div class="col-md-6">
                 ...
                 <a href=""><button class="btn">Save Change</button></a>
