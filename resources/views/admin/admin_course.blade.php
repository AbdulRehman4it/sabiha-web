            ...
            >
              ...
              >
                <div class="header_notification_warp d-flex align-items-center">
                  ...
                  <div class="me-3 new-course-btn">
                    <a href="{{url('admin_dashboard_upload_course')}}" >

                    <img src="{{url('admin./images/video-icon.png')}}"/>
                        ...
                        <div class="row withdrawl-row">
                          ...
                          <div class="col-md-6 col-6">
                            <div class="withdrawl-button">
                              <button class="btn"><a href="{{url('admin_dashboard_course_payout_page')}}">Withdraw</a></button>
                            </div>
                          </div>
                        </div>
                    </div>
                  ...
                  <div class="col-md-12">
                    <div class="performance-row">
                      ...
                      <div class="d-flex performance-main-row">
                        <div class="d-flex">
                          <div class="performance-img-div">
                            <img src="{{url('admin./images/performance-p.png')}}" alt="">
                          </div>
                          <div class="performance-content">
                        ...
                        <div class="d-flex performance-main-row">
                          <div class="d-flex">
                            <div class="performance-img-div">
                              <img src="{{url('admin./images/performance-diamond.png')}}" alt="">
                            </div>
                            <div class="performance-content">
